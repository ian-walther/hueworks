...
Scope: `lib/hueworks/{util,color,kelvin,areas,groups,lights,instance,app_settings,credentials,debug_logging}*`, `lib/mix/tasks/**`, `config/**`, `test/support/**`, and accumulated infrastructure/hygiene work.
