  ...
  test "can send in the clear & upgrade a live socket to encrypted transport" do
    ...
    server_task =
      Task.async(fn ->
        ...
        HAP.HAPSessionTransport.put_send_key(<<1::256>>)
        HAP.HAPSessionTransport.put_recv_key(<<2::256>>)
    ...
    HAP.HAPSessionTransport.put_send_key(<<2::256>>)
    HAP.HAPSessionTransport.put_recv_key(<<1::256>>)
