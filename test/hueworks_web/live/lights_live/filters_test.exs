defmodule HueworksWeb.LightsLive.FiltersTest do
  ...
  test "filter_entities applies source area and disabled filters together" do
    entities = [
      %{id: 1, source: :hue, area_id: 10, enabled: true},
      %{id: 2, source: :hue, area_id: 11, enabled: false},
      %{id: 3, source: :ha, area_id: 10, enabled: true},
      %{id: 4, source: :hue, area_id: nil, enabled: true}
    ]
  ...
  test "filter_lights excludes linked lights unless requested" do
    lights = [
      %{id: 1, source: :hue, area_id: 10, enabled: true, canonical_light_id: nil},
      %{id: 2, source: :hue, area_id: 10, enabled: true, canonical_light_id: 1}
    ]
